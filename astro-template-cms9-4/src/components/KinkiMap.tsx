            ...
            <Marker key={index} position={location.position}>
              ...
              <Popup>
                <div className="p-2">
                  ...
                  <p className="text-base text-gray-600">{location.description}</p>
                  {location.address && (
                    <p className="mt-1 text-base text-gray-500">{location.address}</p>
                  )}
                  {location.activities && location.activities.length > 0 && (
                    <div className="mt-2">
                      <p className="mb-1 text-base font-semibold text-gray-700">主な活動:</p>
